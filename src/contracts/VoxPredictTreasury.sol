...
/**
 * @title VoxPredictTreasury
 * @dev Tesouraria para acumular e gerenciar as taxas da plataforma VoxPredict
 * @notice Versão Produção - Integração com Safe Multisig
 */
contract VoxPredictTreasury is ReentrancyGuard, Ownable, Pausable {
    IERC20 public immutable usdtToken;
    
    // Endereço da Safe da VoxPredict (Ethereum Mainnet)
    address public constant VOXPREDICT_SAFE = 0x3f12fFbbfa1D10e66462Dc41D926F9C72eDd5f5b;
    ...
    function getCurrentMonth() internal view returns (uint256) {
        ...
        uint256 year = 2025;
        uint256 month = ((block.timestamp / 86400 / 30) % 12) + 1; // Aproximação
